...
export function AddCarForm({
  ...
  const form = useForm<z.infer<typeof formSchema>>({
    ...
    defaultValues: {
      ...
      first_registration_year:
        initialData?.first_registration_year || new Date().getFullYear(),
  ...
  async function handleSubmit(values: z.infer<typeof formSchema>) {
    try {
      ...
      if (response?.data) {
        toast.success(
          initialData ? "Car updated successfully" : "Car added successfully"
        );
        onOpenChange(false);
        setStep(1);
      }
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            >
                              ...
                              <SelectContent>
                                {currencies?.data.map((currency: ICurrency) => (
                                  <SelectItem
                                    key={currency.ID}
